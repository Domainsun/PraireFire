package com.praire.fire.utils.statusbarcolor;
...
public class StatusBarUtils {
    ...
    private static final int STATUS_VIEW_ID = R.id.rl_title;// 这个值是错误的临时写的//R.id.status_view;
    private static final int TRANSLUCENT_VIEW_ID = R.id.rl_title ;// 这个值是错误的临时写的//.id.translucent_view;
