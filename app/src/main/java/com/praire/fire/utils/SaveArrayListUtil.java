...
public class SaveArrayListUtil {
    private  final String SAVE_NAME = "PFSearchDataList";
    /**
     * 将arrayList的内容保存到sp里
     */
    public void saveArrayList(Context context, ArrayList searchList, String content) {
        ...
        SharedPreferences.Editor editor = context.getSharedPreferences(
                SAVE_NAME, Context.MODE_PRIVATE).edit();
    ...
    {
        SharedPreferences preferDataList = context.getSharedPreferences(SAVE_NAME,
